...
public class EmprestarLivroController {
    ...
    private void buscarLivro() {
        ...
        if (!livro.getDisponibilidade().equalsIgnoreCase("DISPONIVEL")) {
            Alert alerta = new Alert(Alert.AlertType.WARNING);
            alerta.setTitle("Indisponível");
            alerta.setHeaderText(null);
            alerta.setContentText("Este livro já está emprestado.");
            alerta.showAndWait();
            return;
        }
    ...
    private void confirmarEmprestimo() {
        ...
        if (livro == null) {
            ...
            alerta.setTitle("Erro");
            alerta.setHeaderText(null);
            alerta.setContentText("Livro não encontrado.");
            alerta.showAndWait();
            return;
        }
        ...
        if (!livro.getDisponibilidade().equalsIgnoreCase("DISPONIVEL")) {
            ...
            alerta.setTitle("Indisponível");
            alerta.setHeaderText(null);
            alerta.setContentText("Este livro já está emprestado e não pode ser emprestado novamente.");
            alerta.showAndWait();
            return;
        }
